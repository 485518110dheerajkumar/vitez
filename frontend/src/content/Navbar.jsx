  ...
  return (
    <>
      ...
      <div className="navbar">
        <div className="navbar bg-base-300 w-full max-auto space-x-3 fixed top-0 right-0 left-0 z-40 pl-3 pr-3">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer p-3">VITEZ</a>
          </div>
