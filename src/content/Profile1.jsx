    ...
    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
      <form className="card-body">
        <div className="form-control">
          ...
          <input type="email" placeholder="User Name" className="input input-bordered border-t-0 border-l-0 border-r-0"/>
        </div>
        <div className="form-control">
          <label className="label">
        ...
        <div className="form-control">
          ...
          <input type="email" placeholder="Location" className="input input-bordered border-t-0 border-l-0 border-r-0"/>
        </div>
        <div className="form-control">
          <label className="label">
